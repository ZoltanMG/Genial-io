...
function creadorListaFecha(objeto) {
  // Genera 3 listas apartir de la lista genral para crear la estadistica
  let listaFecha = [];
...
function separadorDeJornadas(objeto) {
  // determinar si es de la jornada diurna o no
...
// promedio general
// procentaje de productividad mas alto registrado
// procentaje de productivida mas bajo registrado
